...
class View:
    ...
    def load_interface(self):
        ...
        # TODO
        self.pulsante_cammino_minimo = ft.ElevatedButton(text = "Cammino Minimo", width=200, on_click=self.controller.handle_cammino_minimo if self.controller else None)
